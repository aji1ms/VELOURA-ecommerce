    ...
    return (
        <footer className="border-t py-12">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
                <div>
                    <h3 className="text-lg text-color-800 font-semibold mb-4">Newsletter</h3>
                    <p
                        className="text-gray-500 text-sm mb-4">
                        Be the first to hear about new products, exclusive events, and online offers.
                    </p>
                    <p
                        className="font-medium text-sm text-gray-600 mb-6">
                    ...
                    <form className="flex">
                        <input
                            ...
                            className="p-3 w-full text-sm border-t border-l border-b border-gray-300
                             rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
                            required
                        />
                        <button
                            type="submit"
                            className="bg-black text-white px-6 py-3 text-sm 
                            rounded-r-md hover:bg-gray-700 transition-all">
                            Subscribe
                        </button>
                    </form>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 text-gray-600 text-md">
                        <li>
                            <Link to="#"
                                className="hover:text-gray-500 text-sm transition-colors">
                                Men's Top Wear
                            </Link>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-600 text-md">
                        <li>
                            <Link to="#"
                                className="hover:text-gray-500 text-sm transition-colors">Contact Us
                            </Link>
                        </li>
                        <li>
                            <Link to="#"
