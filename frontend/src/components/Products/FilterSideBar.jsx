...
const FilterSideBar = () => {
  ...
  return (
    <div className='p-4'>
          ...
          {colors.map((color) => (
            <button
              ...
              className={`w-8 h-8 border border-gray-300 cursor-pointer
                 transition hover:scale-105 ${filters.color === color ? "ring-blue-500" : ""}`}
      ...
      {/*Materials Filter*/}
      <div className='mb-6'>
        <label className='block text-gray-800 font-semibold mb-2' >Material</label>
      ...
      {/*Price Filter*/}
      <div className='mb-6'>
        <label className='block text-gray-800 font-semibold mb-2' >Price Range</label>
        <input
          type="range"
          name="priceRange"
          min={0} max={2000}
